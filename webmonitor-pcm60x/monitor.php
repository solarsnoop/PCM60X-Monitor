...
if ( ( $result <<= 1 ) & 0x10000 ) $result ^= CRC16POLYN;<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
<!DOCTYPE html>
<html lang="en">
<head>
<style>
...
echo '<br>HEXCODE: '.$out;
echo '</center><br>';
file_put_contents("/home/pi/pyhton/transfer.txt", $out);
shell_exec("sudo python /home/pi/pyhton/sendcode.py");  
}
...
shell_exec("sudo python /home/pi/pyhton/qpiri.py");
shell_exec("sudo python /home/pi/pyhton/qpigs.py");
...
<center><p><button class="styled">Save new settings</button>&nbsp;&nbsp;&nbsp;&nbsp;<button class="styled">Refresh monitor</button></p>
</form>
</td></tr></table>
<hr>
